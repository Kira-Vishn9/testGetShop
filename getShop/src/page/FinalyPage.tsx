        ...
        <>
            <Box sx={{widht: '100%', height: '100%', minWidth: '1280px', minHeight: '720px', backgroundImage: `url(${img})`, position: 'relative'}}>
                <Box sx={{display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '720px'}}>
                    <Box sx={{ background: "#86D3F4", width: "284px", height: "100%", textAlign: '-webkit-center',display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        <Typography
                            sx={{color: 'black', fontSize: '32px', width: "284px", height: "76px", lineHeight: "37.5px", fontWeight: 900,
                                letterSpacing: '-0.6px', wrodSpacing: '1px'}}>
                            ЗАЯВКА ПРИНЯТА
                        </Typography>
                        <Typography
                            sx={{color: 'black', fontSize: '14px', width: "290px", height: "32px", lineHeight: "16.41px", fontWeight: 400,
                                letterSpacing: '-0.6px', wrodSpacing: '1px'}}>
